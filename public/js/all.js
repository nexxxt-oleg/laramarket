...
$(function () {
    ...
    }); // Личный кабинет данные

    $('.lcPageContentDataChange__img').on('click', function () {
        $(this).parent().next().slideDown();
        $(this).parent().next().find('input').focus();
    });
    $('.lcPageContentDataAddress__btn').on('click', function () {
        ...
        if (w >= 768) {
            ...
            $('.lcPageContentDataAddresses .lcPageContentDataChange__inpWrap').slideDown();
            $('.lcPageContentDataAddresses .lcPageContentDataChange__inpWrap').find('input').focus();
        }
    });
    $('.lcPageContentDataChange__inp input').on('blur', function () {
        $('.lcPageContentDataChange__inpWrap').slideUp();
    });
    $('.lcPageContentDataChange__icon').on('click', function () {
        $('.lcPageContentDataChange__inpWrap').slideUp();
    }); // Личный кабинет помощь

    $('.lcPageHelpItem__title, .lcPageHelpItem__icon').on('click', function () {
        $(this).parent().find('.lcPageHelpItemSlide').slideToggle();
        $(this).parent().toggleClass('lcPageHelpItem-active');
    });
    $('.lcPageHelpItemSlideItem__title').on('click', function () {
        $(this).next().slideToggle();
    });
    $('.lcPageHelpArchTop__icon').on('click', function () {
        $(this).next().slideToggle();
    });
    $('.lcPageHelpArchLeft__item').on('click', function () {
        var w = $(document).width();
    ...
    $('.lcPageContentPayChoose__item').on('click', function () {
        $('.lcPageContentPayChoose__item').removeClass('lcPageContentPayChoose__item-active');
        $(this).addClass('lcPageContentPayChoose__item-active');
        $('.lcPageContentPayChoose__check input').removeAttr('checked');
        $(this).find('.lcPageContentPayChoose__check input').attr('checked', 'true');
        var ind = $(this).index();
        $('.lcPageContentPay').removeClass('lcPageContentPay-active');
        $('.lcPageContentPay').eq(ind).addClass('lcPageContentPay-active');
    });
    $('.lcPageContentPayTop__btn').on('click', function () {
        $('.lcPayWrap').slideDown();
        setTimeout(function () {
            var top = $('.lcPayWrap').offset().top;
            $(document).scrollTop(top);
        }, 200);
    });
    ...
    $('.lcPageContentCol__drop').hover(function () {}, function () {
        $(this).fadeOut();
    });
    $('.moneyBack-modal').on('click', function () {
        $('.popUp-money').fadeIn();
    });
    $('.moneyBack__cross, .popUp__layer').on('click', function () {
        $('.popUp-money').fadeOut();
    });
    $('.userRegTopSort .catalogSort__drop span').on('click', function () {
        var oldAttr = $('.userRegTopSort>span').attr('name');
        var newAttr = $(this).attr('name');
        $('.userRegTopSort>span').attr('name', newAttr);
        $(this).attr('name', oldAttr);
        $('.userRegContent').removeClass('userRegContent-active');
        $('.userRegContent[name="' + newAttr + '"]').addClass('userRegContent-active');
    });
    ...
    var flag = true;
    $('.userRegInp-after').on('click', function () {
        $(this).toggleClass('userRegInp-after-active');
        var inf = $(this).parent().parent().parent().find('.userRegInp-ur input').val();
